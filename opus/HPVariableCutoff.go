...
import "github.com/dosgo/libopus/silk"
...
func silk_HP_variable_cutoff(state_Fxx []*silk.SilkChannelEncoder) {
	...
	if psEncC1.prevSignalType == SilkConstants.TYPE_VOICED {
		...
		psEncC1.variable_HP_smth1_Q15 = inlines.Silk_SMLAWB(psEncC1.variable_HP_smth1_Q15, silk_SMULBB(psEncC1.speech_activity_Q8, delta_freq_Q7), smth_coef1_Q16)
